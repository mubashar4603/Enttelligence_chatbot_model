#!/usr/bin/env python3
"""
🔍 PINECONE VECTOR COUNT CHECKER & CHECKPOINT UPDATER
Check actual vectors in Pinecone and update checkpoints accordingly
"""
...
class PineconeVectorChecker:
    ...
    def check_sample_vectors(self, limit=5):
    ...
    def update_checkpoint(self, pinecone_stats):
        ...
        try:
            checkpoint_path = os.path.join(self.config['CHECKPOINT_DIR'], 'pinecone_vector_checkpoint.json')
